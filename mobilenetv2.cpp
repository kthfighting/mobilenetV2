...
int main()
{
    std::string folder_path = "/workspace/shared/dataset/1TB_HDD/Dataset/cocoDataset/val2017";
    std::string output_filename = "/workspace/c++DeepLearning/test1/Final_Output/Final_Output.csv";
    ...
    for (const auto &entry : std::filesystem::directory_iterator(folder_path))
    {
        ...
        // 이미지 체크용
        std::string output_image_path1 = "/workspace/c++DeepLearning/test1/output_origin.jpg";
        cv::imwrite(output_image_path1, original_image);
        std::string output_image_path2 = "/workspace/c++DeepLearning/test1/output_normalized.jpg";
        ...
        outputFile << output_index << "\t" << duration << "\n";
        outputFile.close();
    }
